...
export const NavMenuBar = () =>{
  ...
  if(open){
    ...
    return (
      ...
      <path d="M5.44482 8.77636V3.22182C5.44482 1.99426 6.43927 1 7.66705 1H9.88927C11.117 1 12.1115 1.99426 12.1115 3.22182V8.77636" stroke="white" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
