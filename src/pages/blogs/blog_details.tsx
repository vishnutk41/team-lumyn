            ...
            <main className="main blog_details">
              ...
              <div className="blog_details_container">
                                ...
                                <div className="blog_title_description">
                                  ...
                                  <h3 className="title"> Vivamus ultricies accumsan mi, sit amet ornare urna tristique vel. Ut aliquam euismod lorem a malesuada. Integer bibendum velit sapien, quis volutpat erat ultrices eu. </h3>
